...
SELECT orderid, CustomerId, empid, orderdate, freight
FROM Sales.Orders;
...
SELECT TOP (5) orderid, orderdate, CustomerId, empid
FROM Sales.Orders
ORDER BY orderdate DESC;

SELECT TOP (1) PERCENT orderid, orderdate, CustomerId, empid
FROM Sales.Orders
ORDER BY orderdate DESC;
...
SELECT TOP (5) WITH TIES orderid, orderdate, CustomerId, empid
FROM Sales.Orders
ORDER BY orderdate DESC;
...
-- AND precedes OR
SELECT orderid, CustomerId, empid, orderdate
FROM Sales.Orders
WHERE
        CustomerId = 1
    AND empid IN(1, 3, 5)
...
SELECT orderid, CustomerId, empid, CAST(orderdate AS DATETIME) AS orderdate
INTO Sales.Orders2
FROM Sales.Orders;
